...
public class DesvioEncadeado {
	...
	public static void main(String[] args) {
		/*Uma ONG resolveu prestar um serviço bem diferente: ela oferece vans para buscar pessoas com qualquer tipo 
		 * de dificuldade de locomoção para poderem votar.
		 * Para evitar problemas no momento do embarque, porém, você foi convidado a criar um programa que valide a 
		 * idade dos passageiros: caso tenham 16 anos ou menos, não podem votar (e nem embarcar). Caso tenham entre 16 anos e 18 incompletos,
		...
		if (idade < 16) {
			...
			System.out.println("Você não votar e nem embarcar");
		} else {
			if(idade > 18) {
